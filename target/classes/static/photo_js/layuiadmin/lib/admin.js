...
layui.define("view", function(e) {
    var a = layui.jquery,
        ...
        A = {
            ...
            sendAuthCode: function(e) {
                ...
                e.elemPhone = a(e.elemPhone), e.elemVercode = a(e.elemVercode), n.on("click", function() {
                    ...
                    if(t === e.seconds && !a(this).hasClass(f)) {
                        ...
                        A.req(a.extend(!0, {
                            url: "http://127.0.0.1:8080/user/sendsms/"+n,
                            type: "post",
                            data: {
                                phone: n
                            },
            ...
            sideFlexible: function(e) {
                var i = d,
                    t = a("#" + h),
                    s = A.screen();
                "spread" === e ? (t.removeClass(x).addClass(g), s < 2 ? i.addClass(v) : i.removeClass(v), i.removeClass(C)) : (t.removeClass(g).addClass(x), s < 2 ? i.removeClass(C) : i.addClass(C), i.removeClass(v)), layui.event.call(this, n.MOD_NAME, "side({*})", {
                    status: e
                })
            },
            on: function(e, a) {
            ...
            tabsBodyChange: function(e, a) {
                a = a || {}, A.tabsBody(e).addClass(u).siblings().removeClass(u), _.rollPage("auto", e), layui.event.call(this, n.MOD_NAME, "tabsPage({*})", {
                    url: a.url,
                    text: a.text
                })
            },
            resize: function(e) {
                var a = layui.router(),
                    i = a.path.join("-");
                o.off("resize", A.resizeFn[i]), e(), A.resizeFn[i] = e, o.on("resize", A.resizeFn[i])
            },
            resizeFn: {},
            runResize: function() {
                var e = layui.router(),
            ...
            delResize: function() {
                var e = layui.router(),
                    a = e.path.join("-");
                o.off("resize", A.resizeFn[a]), delete A.resizeFn[a]
            },
        ...
        _ = A.events = {
            ...
            setTheme: function(e) {
                var a = n.theme,
                    i = e.data("templates.user.index");
                e.siblings(".layui-this").data("templates.user.index");
                e.hasClass(y) || (e.addClass(y).siblings(".layui-this").removeClass(y), a.color[i] && (a.color[i].index = i, A.theme({
                    color: a.color[i]
                })))
            },
    ...
    ! function() {
        ...
        e.theme && A.theme(e.theme), "pageTabs" in layui.setter || (layui.setter.pageTabs = !0), n.pageTabs || (a("#LAY_app_tabs").addClass(c), d.addClass("layadmin-tabspage-none")), l.ie && l.ie < 10 && s.error("IE" + l.ie + "下访问可能不佳，推荐使用：Chrome / Firefox / Edge 等高级浏览器", {
            offset: "auto",
            id: "LAY_errorIE"
        })
        ...
        n.find("." + y).removeClass(y), A.screen() < 2 && A.sideFlexible(), l(n.children("li"))
    }), t.on("nav(layadmin-system-side-menu)", function(e) {
        e.siblings(".layui-nav-child")[0] && d.hasClass(C) && (A.sideFlexible("spread"), layer.close(e.data("templates.user.index"))), A.tabsPage.type = "nav"
    ...
    r.on("click", z, function() {
        var e = a(this),
            i = e.index();
        A.tabsPage.type = "tab", A.tabsPage.index = i, k(e)
    }), t.on("tabDelete(" + p + ")", function(e) {
        var i = a(z + ".layui-this");
        e.index && A.tabsBody(e.index).remove(), k(i), A.delResize()
        ...
        if(!e.parent().hasClass("layui-nav-item") || d.hasClass(C)) {
            ...
            e.data("templates.user.index", s)
        }
    }).on("mouseleave", "*[lay-tips]", function() {
        layer.close(a(this).data("templates.user.index"))
    });
